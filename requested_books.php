<?php 
	...
	if($_SESSION['username'] == "admin") {
		...
		$sql = "SELECT * FROM book_requests WHERE username='$username' AND status='Pending'";
...
<!-- 				<a href="request_book.php?bookid<?php echo $row['book_id'] ?>" class="btn btn-primary" <?php if($_SESSION['username'] == 'admin') { echo "hidden"; } ?>>Request Book</a>
				...
				<a href="delete_request.php?reqid=<?php echo $row['req_id'] ?>" class="btn btn-primary" name="delete-request">Delete Request</a>
